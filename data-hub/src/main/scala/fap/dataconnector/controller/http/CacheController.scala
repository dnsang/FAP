package fap.dataconnector.controller.http
...
import fap.dataconnector.domain.{GetCacheRequest, PutCacheRequest, UserID}
import fap.dataconnector.service.UserCacheService
